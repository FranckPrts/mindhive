            ...
            if (
                ...
                try {
                    ...
                    if (currentLocale !== 'en-us') {
                        try {
                            developToursImport = await import(`../../Dashboard/Develop/tours.${currentLocale}.js`);
                        } catch (localizedError) {
                            // Fallback to English
                            developToursImport = await import('../../Dashboard/Develop/tours.js');
                        }
                    } else {
                        developToursImport = await import('../../Dashboard/Develop/tours.js');
                    }
                ...
                try {
                    ...
                    if (currentLocale !== 'en-us') {
                        try {
                            reviewOverviewToursImport = await import(`../../Dashboard/Review/Overview/tours.${currentLocale}.js`);
                        } catch (localizedError) {
                            // Fallback to English
                            reviewOverviewToursImport = await import('../../Dashboard/Review/Overview/tours.js');
                        }
                    } else {
                        reviewOverviewToursImport = await import('../../Dashboard/Review/Overview/tours.js');
                    }
                ...
                switch (tab) {
                    case 'board':
                        ...
                        try {
                            ...
                            if (currentLocale !== 'en-us') {
                                try {
                                    boardToursImport = await import(`../../Builder/Project/ProjectBoard/tours.${currentLocale}.js`);
                                } catch (localizedError) {
                                    // Fallback to English
                                    boardToursImport = await import('../../Builder/Project/ProjectBoard/tours.js');
                                }
                            } else {
                                boardToursImport = await import('../../Builder/Project/ProjectBoard/tours.js');
                            }
                    ...
                    case 'journal':  // TODO: add tours for visualize -- Not doing till the UI is ready
                        try {
                            componentImport = await import('../../Builder/Project/DataJournal/Wrapper.js');
                        } catch (error) {
            ...
            {hasTour && tours && (
                <div>
                    ...
                    <div key={tourId} style={{ display: 'flex', alignItems: 'center', marginBottom: '1em' }}>
                        ...
                        >
                            <span style={{ color: theme.neutral5, margin: 0, whiteSpace: 'nowrap' }}>{t('walkthroughs.startTourButton')}</span>
                        </button>
                        <div>
