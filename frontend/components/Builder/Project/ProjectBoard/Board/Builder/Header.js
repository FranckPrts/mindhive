                ...
                <div className="headerViewControls">
                  ...
                  {isPDF && (
                    <div className="headerDownloadTrigger">
                      <Tooltip
                        content={t("proposalPage.downloadTooltip", {}, { default: "Download content is based on the status and review step filters selected below." })}
                        side="bottom"
                      >
                        <Button
                          variant="text"
                          ...
                          style={{ color: NEUTRAL_LABEL_COLOR }}
                        >
                          {t("proposalPage.download", {}, { default: "Download" })}
                        </Button>
                      </Tooltip>
                    </div>
                  )}
